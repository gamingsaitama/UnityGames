            ...
            if (Input.touchCount > 0)
            {
                foreach (Touch t in Input.touches)
                {
                    ...
                    else if (Input.GetTouch(t.fingerId).phase == TouchPhase.Moved)
                    {
                        ...
                        if (touchObj != null && touchObj.selectedItem.transform.position.y < -0.4 && touchObj.selectedItem.CompareTag("Strikers"))
                        {
                        ...
                        else if (opptouchObj != null && opptouchObj.selectedItem.transform.position.y > 0.4 && opptouchObj.selectedItem.CompareTag("OppoStrikers"))
                        {
